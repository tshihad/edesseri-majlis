...
const WelfareProgramsContents = {
  ...
  malayalam: [
    "ദാരിദ്ര്യം അനുഭവിക്കുന്ന മഹല്ലു നിവാസികളുടെ ജീവിത നിലവാരം ഉയർത്തുന്നയിനു സഹായകമായ സാമ്പത്തിക പദ്ധതികൾ നടപ്പിലാക്കുക.",
    "സാമ്പത്തിക പ്രയാസം നേരിടുന്ന മഹല്ല് നിവാസികൾക്ക് സാമ്പത്തിക സഹായം നൽകുക.",
    "മഹല്ലിന്റെയുും മഹല്ല് നിവാസികളുടേയും, മത-സാംസ്കാരിക വളർച്ചക്കും പുരോഗമനത്തിനുും സഹായകമായ, മതപരവും ഭൗയികവുമായ വിദ്യാഭ്യാസ സംവിധാനം നടപ്പിലാക്കുന്നതിന് ആവശ്യമായ സഹായം നൽകുക."
